...
class AlarmManager {
 ...
 private:
  ...
  int StoreAlarmInAppControl(app_control_h app_control, AlarmInfo* alarm) const;
  int RestoreAlarmFromAppControl(app_control_h app_control, AlarmInfo* alarm) const;
